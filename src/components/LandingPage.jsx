...
// ---------------------------------------------------------------------------
const NAV_ITEMS = [
  { label: 'Tổng quan', target: 'tong-quan' },
  { label: 'Vị trí', target: 'vi-tri' },
  { label: 'Tiện ích', target: 'tien-ich' },
  { label: 'Mặt bằng', target: 'mat-bang' },
  { label: 'Giá bán', target: 'gia-ban' },
  { label: 'Liên hệ', target: 'lead-form-1' },
]
        ...
        >
          ...
          {NAV_ITEMS.map((item, i) => (
            <button
              ...
              className="relative z-10 whitespace-nowrap rounded-full px-4 py-1.5 text-sm md:text-base font-semibold transition-colors cursor-pointer bg-transparent border-0"
